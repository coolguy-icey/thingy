...
class Main:
    def __init__(self):
        ...
        windll.kernel32.SetConsoleTitleW(
            f'OdysseyChecker-{self.version} | Main menu')
...
'''
        ...
        if not Checker.auto_login:
            print(self.t)
            print(f'''
{Fore.GREEN}|{Fore.WHITE}Welcome to OdysseyChecker
...
''')
            ...
            if mod == "1":
                ...
                if login_status == 0:
                    ...
                    print(
                        f'{Fore.RED}|{Fore.LIGHTWHITE_EX}This tool was coded by {Fore.GREEN}Riftz#0002 who cant code for shit lmao')
                    print(
                ...
                if register_status == 0:
                    ...
                    try:
                        with requests.Session() as sess:
                            ...
                            response_3 = "success"
                            flag3 = 'Odyssey checker sucks'
                            if flag3:
                                if "success" in response_3:
                                    print(
                                        "\n{}, Welcome To Odysseychecker the easiest to crack checker ever".format(username))
                                    time.sleep(2)
                                    system('cls')
                                    Main()
                                else:
            ...
            if login_status == 0:
                ...
                os.system("title Login Menu")
                print(
                    f'{Fore.RED}|{Fore.LIGHTWHITE_EX}This tool was coded by {Fore.GREEN}Riftz#002 Who cant code for shit lmao')
        ...
        if 'Cracked By Hate' == lastver:
            print(f'{Fore.GREEN}You Are Using The Cracked Version')
            from time import time
            hwid = subprocess.check_output(
                'wmic csproduct get uuid').decode().split('\n')[1].strip()
            if Checker.RPC.discordrpc:
                ...
                rpc.update(large_image='large',
                           large_text='Odyssey checker', state='In the menu')
                if Checker.RPC.rpcd:
                    print('RPC set successfully.')
            system('cls')
            windll.kernel32.SetConsoleTitleW(
                f'Odyssey Checker-{self.version} | Select A mode')
            print(self.t)
        else:
            ...
            with open(f'Odysseychecker-V{lastver}.exe', "wb") as file:
...
''')
        ...
        if mode == "4":
            ...
            print(self.t)
            windll.kernel32.SetConsoleTitleW(
                f'Odyssey checker V{self.version} | Module: ProxyChecker')
            ...
            def proxy_check(proxy):
                ...
                try:
                    ...
                    if 'URI' in r:
                        ...
                        rpc.update(large_image='large', large_text='Odysseychecker', state='Checking | Odysseyproxy',
            ...
            if __name__ == '__main__':
                ...
                windll.kernel32.SetConsoleTitleW(
                    f'OdysseyChecker-{self.version} Starting | Odysseyproxy')
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='Odysseychecker', state='Checking Proxies | Odysseyproxy',
                               details=f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                ...
                print(self.t)
                windll.kernel32.SetConsoleTitleW(
                    f'OdysseyChecker-{self.version} Done Checking | Odysseyproxy')
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='Odysseychecker', state='Done Checking | Odysseyproxy',
                               details=f'Unbanned: {Counter.mojangunbanned} Bad: {Counter.invalid}')
                    if Checker.RPC.rpcd:
                        print('Updated RPC')
            ...
            PORT = 25565
            windll.kernel32.SetConsoleTitleW(
                f'Odysseychecker V{self.version} | Module: BanChecker')
            ...
            if __name__ == '__main__':
                ...
                print(self.t)
                windll.kernel32.SetConsoleTitleW(
                    f'OdysseyChecker-{self.version} Asking a few questions | BanChecker')
                flag = True
                while (flag):
                    print(f'{Fore.MAGENTA}')
                    alts_file = input(
                ...
                print(self.t)
                if Checker.RPC.discordrpc:
                    rpc.update(large_image='large', large_text='Odysseychecker',
                               state='Checking | BanChecker', details=f'Server: {SERVER} |  Retries: {RETRIES}')
                    if Checker.RPC.rpcd:
                        print('Updated RPC')
                windll.kernel32.SetConsoleTitleW(
                    f'OdysseyChecker-{self.version} | Checking | BanChecker')
                ...
                for result in as_completed(tasks):
                    print(result.result())
                windll.kernel32.SetConsoleTitleW(
                    f'OdysseyChecker-{self.version} | Done Checking | BanChecker')
                print('Finished!\n')
                mode = input('Press ENTER to get back to the menu')
                import os
                system('cls')
                os.system('"Odysseychecker.exe"')

        elif mode == "5":
            system('cls')
            print(self.t)
            windll.kernel32.SetConsoleTitleW(
                f'Odysseychecker V{self.version} | Module: ComboEditor')
            print(f'''
{Fore.GREEN}|{Fore.WHITE}OPTIONS:
...
''')
            ...
            if Checker.RPC.discordrpc:
                rpc.update(large_image='large', large_text='Odysseychecker',
                           details=' Scraping Proxies | OdysseyProxy')
                if Checker.RPC.rpcd:
                    print('Updated RPC')
            windll.kernel32.SetConsoleTitleW(
                f'OdysseyChecker-{self.version} | Scraping Proxies | OdysseyProxy')
            ...
            while True:
                ...
                if len(urls) > 0:
                    ...
                    break
            windll.kernel32.SetConsoleTitleW(
                f'OdysseyChecker-{self.version} | Done Scraping | OdysseyProxy')
            if Checker.RPC.discordrpc:
                rpc.update(large_image='large', large_text='Odysseychecker',
                           details=' Done Scraping | OdysseyProxy')
            ...
            if __name__ == '__main__':
                windll.kernel32.SetConsoleTitleW(
                    f'Odysseychecker V{self.version} | Module: MailAccess')
                system('cls')
                print(self.t)
                mailfile = input(
        ...
        print(f'{Fore.MAGENTA}[Odysseychecker] Starting Threads...\n')
        windll.kernel32.SetConsoleTitleW(
            f'OdysseyChecker-{self.version} | Getting ready!')
        ...
        def updaterpc():
            while True:
                rpc.update(large_image='large', large_text='Odysseychecker', state='Checking Accounts',
    ...
    def discordbot(self):
        ...
        async def pause(ctx):
            ...
            if ctx.message.author.id in users:
                if not self.Paused:
                    ...
                    self.prints(f'{Fore.MAGENTA}[Odysseychecker] Checking Paused')
                else:
        ...
        async def resume(ctx):
            ...
            if ctx.message.author.id in users:
                if self.Paused:
                    ...
                    self.prints(
                        f'{Fore.MAGENTA}[Odysseychecker] Checking Resumed')
                else:
        ...
        async def stats(ctx):
            ...
            if ctx.message.author.id in users:
                ...
                await ctx.send('**Thank you for using OdysseyChecker**')
